...
func (sb *backend) AccumulateRewards(state *state.StateDB, beneficiaryAdd common.Address) {
	blockRewards := big.NewInt(3e+18)
	state.AddBalance(beneficiaryAdd, blockRewards)
}
